...
import co.poynt.os.services.v1.IPoyntCustomLoyaltyService;
...
/**
 * Created by sushil.kumar on 20-12-2017.
 */
...
//                intent.setComponent(new ComponentName(getPackageName(), DiscountActivity.class.getName()));
