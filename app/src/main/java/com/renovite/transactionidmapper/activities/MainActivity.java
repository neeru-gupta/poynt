...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("MainActivity", "The onCreate() event");
    ...
    protected void onStart() {
        super.onStart();
        Log.d("MainActivity", "The onStart() event");
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.d("MainActivity", "The onResume() event");
    }
    ...
    protected void onPause() {
        super.onPause();
        Log.d("MainActivity", "The onPause() event");
    }
    ...
    protected void onStop() {
        super.onStop();
        Log.d("MainActivity", "The onStop() event");
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.d("MainActivity", "The onDestroy() event");
    }

    @Override
    public void onClick(View view) {
        Log.d("MainActivity", "EVENT CLICK CALLED!*********");
