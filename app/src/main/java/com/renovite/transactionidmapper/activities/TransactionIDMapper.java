...
import com.renovite.transactionidmapper.MapperAccessibilityService;
...
public class TransactionIDMapper extends AppCompatActivity implements DlgInterface, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //url.setText("https://f57f7591.ngrok.io/orders/");
    ...
    protected void onResume() {
        super.onResume();
        if(isAccessibilitySettingsOn(this)==false)
            button_accesiblity.setVisibility(View.GONE);
        else
            button_accesiblity.setVisibility(View.GONE);
    ...
    public void onClick(View view) {
        ...
        }else if(view==button_accesiblity)
        {
            if(isAccessibilitySettingsOn(this)==false)
    ...
    private boolean isAccessibilitySettingsOn(Context mContext) {
        ...
        final String service = getPackageName() + "/" + MapperAccessibilityService.class.getCanonicalName();
        try {
