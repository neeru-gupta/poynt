...
public interface Constants extends WSConstants {
    ...
    String CARD = "card";
    String CASH = "cash";
    boolean SHOW_MERCHANT_DIALOG = false;
    String MESSAGE = "Mobile no should not be less than 7 digits!";
    String ITEMS = "ITEMS";
    String POUNDS = "POUNDS";
    String FEET = "FEET";
    String ORDER_STATUS = "IN_PROCESS";
    String OPTIN_CHANNEL = "FACEBOOK_MESSENGER";
    String TAX_TYPE = "REGION";
    String ORDER_TYPE = "IN_STORE";
}
