...
public class TextViewUndoRedo {
        ...
        /**
         * Is the TextChangeListener activated?
         */
 ...
 //               mTextView.addTextChangedListener(mChangeListener);
        ...
        /**
         * Activates or deactivates the text view listener.
         *
         * @param state
         *            true/false.
         */
        public void ActivateListener(boolean state) {                
        	mActivated = state;
        }        
        ...
        /**
         * Add a text change listener to an edit text
         */
        public void AddTextChangeListener(TextView textView) {
        	mTextView = textView;
        	mTextView.addTextChangedListener(mChangeListener);
        }
