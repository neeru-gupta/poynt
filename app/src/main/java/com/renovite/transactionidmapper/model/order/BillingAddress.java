...
public class BillingAddress implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = 6071799342188810970L;
     ...
     * @param country
     */
    public BillingAddress(String country, String locality, String postalCode, String region, List<String> streetLines) {
        super();
    ...
    public BillingAddress withLocality(String locality) {
        this.locality = locality;
        return this;
    }
    ...
    public BillingAddress withStreetLines(List<String> streetLines) {
        this.streetLines = streetLines;
        return this;
    }
